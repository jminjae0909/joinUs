				...
				<ul class="three_line_ul">
					<li class="three_line_li1">
						...
						<div>
							...
							aria-describedby="basic-addon2" name="meeting_startdate" id="meeting_startdate" value="미정">					
						</div>
					</li>
					<li class="three_line_li2">
						<label class="label">모임 장소</label>
						<div>
							<input type="text"  class="form-control" name="meeting_place" id="addr" size="30" placeholder="주소 찾기"/>											
						</div>
					</li>
				</ul>
			</div>
			...
			<div>
				<ul class="four_line_ul">
					...
					<li class="four_line_li2">
						<label style="margin-left: -50px;" class="label">사용 기술</label>
