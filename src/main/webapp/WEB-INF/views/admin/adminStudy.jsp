            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">스터디 게시글 관리</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/admin">대시보드</a></li>
                            <li class="breadcrumb-item active">스터디 게시글 관리</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                스터디 게시물의 수정, 삭제, 추가를 지원합니다.
                            </div>
                        </div>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <c:forEach items="${list }" var="dto">
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<a href="/adminStudyDelete?no=${dto.meeting_number }"><button type="button" class="btn btn-outline-danger">삭제</button></a>
	                                            </td>
	                                        </tr>
                                    	</c:forEach>
                                    </tbody>
