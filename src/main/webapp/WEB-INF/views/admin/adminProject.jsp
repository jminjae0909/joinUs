...
<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/joinus/main">CODEE</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/adminProject">프로젝트</a>
                                    <a class="nav-link" href="/adminStudy">스터디</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">프로젝트 게시글 관리</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/admin">대시보드</a></li>
                            <li class="breadcrumb-item active">프로젝트 게시글 관리</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                프로젝트 게시글의 수정, 삭제, 추가를 지원합니다.
                            </div>
                        </div>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                    	<c:forEach items="${list }" var="dto">
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<a href="/adminProjectDelete?no=${dto.meeting_number }"><button type="button" class="btn btn-outline-danger">삭제</button></a>
	                                            </td>
	                                        </tr>
                                    	</c:forEach>
                                    </tbody>
