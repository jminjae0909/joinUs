...
<div class="container" id="container">
	...
	<div id="regist">회원정보수정</div>
	<form action="/regist" method="post" onsubmit="return checkAll()">
			<label for="id" class="form-label" >아이디</label>
		<div class="input-group mb-3">
			<input type="text" id="id" name="users_id" class="form-control" placeholder="아이디" aria-label="Recipient's username" aria-describedby="button-addon2" value="${ldto.users_id }" readonly>
